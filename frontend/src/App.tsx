...
function ChallengesView({ items, total, category, onCategory, difficulty, onDifficulty, challengeSearch, onSearchChange, onOpen }: { items: ChallengeSummary[]; total: number; category: Filter; onCategory: (value: Filter) => void; difficulty: DifficultyFilter; onDifficulty: (value: DifficultyFilter) => void; challengeSearch: string; onSearchChange: (value: string) => void; onOpen: (item: ChallengeSummary) => void }) {
  ...
  if (categoryOptions.length > 4) return <ChallengeCatalog items={items} total={total} category={category} categoryOptions={categoryOptions} onCategory={onCategory} difficulty={difficulty} onDifficulty={onDifficulty} onOpen={onOpen} page={page} pageCount={pageCount} visibleItems={visibleItems} onPageChange={setPage} ko={ko} />
...
function ChallengeCatalog({ items, total, category, categoryOptions, onCategory, difficulty, onDifficulty, onOpen, page, pageCount, visibleItems, onPageChange, ko }: { items: ChallengeSummary[]; total: number; category: Filter; categoryOptions: Filter[]; onCategory: (value: Filter) => void; difficulty: DifficultyFilter; onDifficulty: (value: DifficultyFilter) => void; onOpen: (item: ChallengeSummary) => void; page: number; pageCount: number; visibleItems: ChallengeSummary[]; onPageChange: (page: number) => void; ko: boolean }) {
