...
function ProviderIcon({ provider }: { provider: string }) {
  ...
  if (provider === 'kakao') return <svg className="oauth-provider-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 3C6.48 3 2 6.5 2 10.82c0 2.73 1.79 5.13 4.5 6.5L5.47 21l4.22-2.24c.76.13 1.54.2 2.31.2 5.52 0 10-3.5 10-7.82S17.52 3 12 3Zm-3.1 5.96h1.42l1.68 3.66 1.67-3.66h1.43L12 15.62 8.9 8.96Z" /></svg>
