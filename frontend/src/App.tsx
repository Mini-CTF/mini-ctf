...
function FlagBoxIntro({ onSkip }: { onSkip: () => void }) {
  return <div className="flagbox-intro flagbox-stroke-intro" role="status" aria-label="FlagBox is loading.">
    ...
    <StrokeText text="FlagBox" className="flagbox-stroke-intro__wordmark" fontSize={230} letterSpacing={-19} strokeColor="#f8fafc" fillColor="#f8fafc" strokeWidth={1.5} drawDuration={1.35} fillDelay={0.4} />
