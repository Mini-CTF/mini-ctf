...
public final class LearningDtos {
  ...
  public record Overview(int weeklyTarget, int weeklySolved, int totalSolved, int bookmarkedCount, List<RecentSolve> recentSolves, List<Achievement> achievements) {}
  public record RecentSolve(Long challengeId, String title, String category, Instant solvedAt) {}
  public record Bookmark(Long challengeId, String title, String category, String difficulty, int score, boolean solved, Instant createdAt) {}
